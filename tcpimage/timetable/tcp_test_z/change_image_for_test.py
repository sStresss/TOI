...
class UpdateImage:
    ...
    def run(self):
        ...
        in_image_path = self.in_path + self.input_image
    ...
    def create_json_plan_list(self):
        ...
        self.raster_name.append(self.input_image)
        in_image = os.path.join(self.in_path, self.input_image)
